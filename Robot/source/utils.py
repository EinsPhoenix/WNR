...
def resize_window(self, add_width: int = 0, add_height: int = 0, resize_width: bool = True) -> None:
    """
    ...
    Args:
        ...
        resize_width (bool, optional): Whether to resize the width. Defaults to True.
    """
    self.setMinimumSize(0, 0)
    self.setMaximumSize(16777215, 16777215)
    QTimer.singleShot(0, lambda: check_min_size(self, add_width, add_height, resize_width))
...
def check_min_size(self, add_width: int, add_height: int, resize_width: bool) -> None:
    """
    ...
    Args:
        ...
        resize_width (bool): Whether to resize the width.
    """
    if not resize_width:
        self.setFixedSize(self.size().width(), self.size().height() + add_height)
    else:
        self.adjustSize()
