<script lang="ts">
    ...
    import { initMqtt } from "$lib/stores/mqttClient";
    ...
    function setActive(index: number, action: () => void) {
        activeIndex = index;
  ...
  <nav class:sticky={isSticky}>
    ...
    <div class="navbar-wrapper">
        ...
        <div class="item-wrapper">
            <button class="item-text" class:item-active={activeIndex === 0} on:click={() => setActive(0, goHome)}>
        ...
        <div class="item-wrapper">
            <button class="item-text" class:item-active={activeIndex === 1} on:click={() => setActive(1, goMessages)}>
        ...
        <div class="item-wrapper">
            <button class="item-text" class:item-active={activeIndex === 2} on:click={() => setActive(2, goNotifications)}>
        ...
        <div class="item-wrapper">
            <button class="item-text" class:item-active={activeIndex === 3} on:click={() => setActive(3, goSettings)}>
